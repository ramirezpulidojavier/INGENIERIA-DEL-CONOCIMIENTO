...
(influye  zona_vivienda Covid)  ; la tasa en la zona en la que vive influye en la probabilidad de Covid
(influye  vacunacion Covid)    ; estar vacunado o no influye en la probabilidad de Covid
...
(prob zona_vivienda incidencia_alta 0.1)
(prob zona_vivienda incidencia_media 0.1)
(prob zona_vivienda incidencia_baja 0.8)
(prob vacunacion si 0.7)
(prob vacunacion no 0.3)
)

;-------------------------------------------------------------------------------------------------
(deffacts distribucion_segun_valores_variables_que_influyen
(probcond2 Covid SI zona_vivienda incidencia_alta vacunacion si 0.005)
(probcond2 Covid SI zona_vivienda incidencia_alta vacunacion no 0.022)
(probcond2 Covid SI zona_vivienda incidencia_media vacunacion si 0.0008)
(probcond2 Covid SI zona_vivienda incidencia_media vacunacion no 0.012)
(probcond2 Covid SI zona_vivienda incidencia_baja vacunacion si 0.00006)
(probcond2 Covid SI zona_vivienda incidencia_baja vacunacion no 0.0008)
)
  

(deffacts probabilidad_efectos
(probcond tos si Covid SI 0.962)
(probcond tos si Covid NO 0.036)
(probcond fiebre alta Covid SI 0.98)
(probcond fiebre alta Covid NO 0.017)
(probcond fiebre moderada Covid SI 0.54)
...
(red causal causas)
=>
(printout t "Escribe una opcion: La zona en la que vive tiene una incidencia alta (1=alta 2=media 3=baja 4=Desconocido): " )
(bind ?respuesta (read))
(if (= ?respuesta 1) then (assert (valor zona_vivienda incidencia_alta))
  else (if (= ?respuesta 2) then (assert (valor zona_vivienda incidencia_media))
...
(red causal efectos)
=>
(printout t "Tiene fiebre (1=alta 2=moderada 3=no 4=Desconocido): " )
(bind ?respuesta (read))
